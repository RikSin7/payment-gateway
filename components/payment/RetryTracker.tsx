...
export default function RetryTracker() {
    ...
    return (
      <div className="w-full flex flex-col items-center gap-3 mt-4">
        ...
        <button
          ...
          className="w-full cursor-pointer py-2.5 mt-2 rounded-lg border border-border-primary text-text-primary text-sm font-medium hover:bg-bg-primary transition-colors focus:outline-none focus-visible:ring-1 focus-visible:ring-accent/50 focus-visible:ring-offset-1 focus-visible:ring-offset-bg-surface"
        >
          Start New Payment
        </button>
      </div>
  ...
  return (
    <div className="w-full flex flex-col gap-3 mt-4">
      ...
      <button
        onClick={handleRetry}
        className="w-full cursor-pointer py-2.5 rounded-lg bg-accent hover:bg-accent-hover text-accent-text text-sm font-medium transition-colors focus:outline-none focus-visible:ring-1 focus-visible:ring-accent/50 focus-visible:ring-offset-1 focus-visible:ring-offset-bg-surface"
      >
        Retry Payment
      </button>
      ...
      <button
        onClick={handleNewPayment}
        className="w-full cursor-pointer py-2 text-xs text-text-secondary hover:text-text-primary transition-colors focus:outline-none focus-visible:ring-1 focus-visible:ring-accent/50 focus-visible:ring-offset-1 focus-visible:ring-offset-bg-surface"
      >
